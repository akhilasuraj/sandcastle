...
```bash
npm install --save-dev @akhilasuraj/sandcastle
```
...
| ---------- | ---------------------------------------------- | ---------- | --------------------------------------------- |
| Docker     | `@akhilasuraj/sandcastle/sandboxes/docker`     | Bind-mount | `run()`, `createSandbox()`, `interactive()`   |
| Podman     | `@akhilasuraj/sandcastle/sandboxes/podman`     | Bind-mount | `run()`, `createSandbox()`, `interactive()`   |
| Vercel     | `@akhilasuraj/sandcastle/sandboxes/vercel`     | Isolated   | `run()`, `createSandbox()`, `interactive()`   |
| No-sandbox | `@akhilasuraj/sandcastle/sandboxes/no-sandbox` | None       | `interactive()`, `wt.interactive()` (default) |
...
import { vercel } from "@akhilasuraj/sandcastle/sandboxes/vercel";
import { noSandbox } from "@akhilasuraj/sandcastle/sandboxes/no-sandbox";
...
```typescript
import { createSandbox, claudeCode } from "@akhilasuraj/sandcastle";
import { docker } from "@akhilasuraj/sandcastle/sandboxes/docker";
...
```typescript
import { createWorktree } from "@akhilasuraj/sandcastle";
...
```typescript
import { run } from "@akhilasuraj/sandcastle";
